...
var Botliy = class {
  ...
  async postStats(options) {
    ...
    try {
      ...
      if (error.response) {
        throw new Error(`Botliy API Error [${error.response.status}]: ${((_a = error.response.data) == null ? void 0 : _a.message) || "Failed to post stats"}`);
      }
      throw error;
    }
  }
  ...
  async getStats() {
    ...
    try {
      ...
      if (error.response) {
        throw new Error(`Botliy API Error [${error.response.status}]: ${((_a = error.response.data) == null ? void 0 : _a.message) || "Failed to get stats"}`);
      }
      throw error;
    }
  }
  ...
  async getVotes() {
    ...
    try {
      ...
      if (error.response) {
        throw new Error(`Botliy API Error [${error.response.status}]: ${((_a = error.response.data) == null ? void 0 : _a.message) || "Failed to get votes"}`);
      }
      throw error;
    }
  }
  ...
  async checkVote(userId) {
    ...
    try {
      ...
      if (error.response) {
        throw new Error(`Botliy API Error [${error.response.status}]: ${((_a = error.response.data) == null ? void 0 : _a.message) || "Failed to check vote"}`);
      }
      throw error;
    }
  }
